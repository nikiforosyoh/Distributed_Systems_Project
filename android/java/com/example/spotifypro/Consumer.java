...
public class Consumer extends Node implements Parcelable {
    ...
    public static ArrayList<ArrayList<String>> getArtists() {
        return artists;
    }
    ...
    public ArrayList<MusicFile> openConsumer(String requestArtist, String requestSong, HashMap<String, Info> brokerArtists) throws IOException {
...
//                        return chunkList;
    ...
    protected Consumer(Parcel in) {
        brokerArtists = (HashMap) in.readValue(HashMap.class.getClassLoader());
    }
